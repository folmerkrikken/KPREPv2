...
cdo -f nc copy ghcn_cams_1948_cur_2.5.grb ghcn_cams_1948_cur_2.5.nc
cdo -f nc copy ghcn_cams_1976_2006.clim.grb ghcn_cams_1979_2006.clim.nc
...
rm -f inputdata/slp_mon_mean_1901_current_r${res}.nc
